...
class PConv(nn.Module):
    """Partial Convolution (PConv) from FasterNet Only applies convolution to a subset of input channels.
    """
    ...
    def __init__(self, c1, c2, k=3, s=1, n_div=4, forward="split_cat", p=None, g=1, bias=False):
        ...
        self.partial_conv3 = nn.Conv2d(
            self.dim_conv3, self.dim_conv3, kernel_size=k, stride=s, padding=p, groups=g, bias=bias
        )
