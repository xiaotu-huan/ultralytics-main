...
from timm.layers import CondConv2d, DropPath, SqueezeExcite, drop_path
from timm.layers.activations import hard_sigmoid

# 导入官方的Conv类
from .conv import Conv

__all__ = ["C3k2_GhostConv"]
...
class C3k(nn.Module):
    """C3k bottleneck block for YOLOv11."""
...
class C3k2_GhostConv(nn.Module):
    """C3k2 module with GhostConv for YOLOv11."""
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, c3k=False):
        ...
        if c3k:
            self.m = C3k(self.c, self.c, n=n, shortcut=shortcut, g=g, e=1.0)
        else:
